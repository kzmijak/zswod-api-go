...
func (ac *AttachmentCreate) SetIconId(s string) *AttachmentCreate {
	ac.mutation.SetIconId(s)
	return ac
}

// SetNillableIconId sets the "iconId" field if the given value is not nil.
func (ac *AttachmentCreate) SetNillableIconId(s *string) *AttachmentCreate {
	if s != nil {
		ac.SetIconId(*s)
	}
	return ac
...
func (ac *AttachmentCreate) SetBlobID(id uuid.UUID) *AttachmentCreate {
	ac.mutation.SetBlobID(id)
	return ac
}
...
func (ac *AttachmentCreate) check() error {
	...
	if _, ok := ac.mutation.BlobID(); !ok {
		return &ValidationError{Name: "blob", err: errors.New(`ent: missing required edge "Attachment.blob"`)}
	}
	return nil
}
...
func (ac *AttachmentCreate) createSpec() (*Attachment, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.IconId(); ok {
